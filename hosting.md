...
- ssh into the server
    - For Mac and Linux: `ssh mathey@mikeathey.xyz`
...
- Test Changes
    - `exit`
    - Mac/Linux: `ssh mathey@mikeathey.xyz`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- create a directory for your deployment
    - `sudo mkdir /var/www/mikeathey.xyz/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/mikeathey.xyz/html`
...
- `sudo vim /etc/nginx/sites-available/mikeathey.xyz`
...
server {
    ...
    root /var/www/mikeathey.xyz/html;
    index index.html index.htm index.nginx-debian.html;

    server_name mikeathey.xyz www.mikeathey.xyz;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/mikeathey.xyz /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
  - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/mathey/.ssh/github_deploy_key`
  - Don't enter a passphrase
    - hit enter twice
- Copy the public key into your authorized keys file
  - `cat /home/mathey/.ssh/github_deploy_key.pub >> /home/mathey/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
  ...
  - `cat /home/mathey/.ssh/github_deploy_key`
